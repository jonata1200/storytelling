...
@pytest.mark.unit
def test_storage_usage_read_does_not_expose_absolute_path():
...
@pytest.mark.unit
def test_storage_file_read_path_is_relative():
...
@pytest.mark.unit
def test_storage_file_read_with_absolute_path_still_relative_in_practice():
