...
def _fallback_script_content_from_bible(
    ...
    return "\n\n".join(
        [
            ...
            (
                "CENA 03 - EXT. RUA DIANTE DA CASA - MADRUGADA\n\n"
            ...
            (
                f"CENA 04 - INT. {location} - AMANHECER\n\n"
            ...
            (
                "CENA 05 - EXT. FRENTE DA CASA - MANHA\n\n"
