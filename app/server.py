"""CLI do servidor: parsing de argumentos e bootstrap do uvicorn.

Impede bind em interfaces não-loopback sem ``APP_API_TOKEN`` configurado e
alerta sobre ``APP_SECRET_KEY`` padrão antes de subir o servidor.
"""
