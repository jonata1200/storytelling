...
class QAResult(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    segment_id: Mapped[UUID] = mapped_column(
        ForeignKey("continuous_video_segments.id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
...
class ContinuousVideoPlan(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    segment_duration_seconds: Mapped[int] = mapped_column(Integer, default=8, nullable=False)
