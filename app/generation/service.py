...
DEFAULT_TEMPLATES: dict[str, str] = {
    ...
    "generate_script": (
        ...
        "da pessoa que fala; se não houver personagem falando, escreva a informação "
        "como ação visual, não como diálogo. "
    ...
    "generate_visual_bible": (
        ...
        "O nome de cada objeto deve representar um único prop isolável para imagem, "
    ...
    "generate_storyboard_prompts": (
        ...
        "image-to-video vertical 9:16. O estilo global deve ser sempre fotorrealista, "
        "live-action cinematográfico e fiel às referências canônicas da biblioteca visual. "
        ...
        "Não use desenho, animação, cartoon, anime, quadrinhos, 3D render, pintura, "
        "concept art ou estética ilustrada. "
