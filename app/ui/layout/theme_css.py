...
THEME_HEAD_HTML = r"""
        ...
        <style>
          ...
          body:not(.body--dark) .border-amber-800 { border-color:#b45309!important; }
          body:not(.body--dark) .bg-amber-950\/30 { background:rgba(251,191,36,.14)!important; }
          body:not(.body--dark) .text-amber-100,
          body:not(.body--dark) .text-amber-200 { color:#92400e!important; }
